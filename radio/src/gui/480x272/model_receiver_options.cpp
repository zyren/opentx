...
bool menuModelReceiverOptions(event_t event)
{
  ...
  SUBMENU(STR_RECEIVER_OPTIONS, ICON_MODEL_SETUP, ITEM_RECEIVER_SETTINGS_PINMAP_FIRST + outputsCount, {
    ...
    IF_ALLOW_RACING_MODE(INTERNAL_MODULE, IS_RECEIVER_CAPABILITY_ENABLED(RECEIVER_CAPABILITY_RACING_MODE)),//IF_RECEIVER_CAPABILITY(RECEIVER_CAPABILITY_RACING_MODE, 0),
